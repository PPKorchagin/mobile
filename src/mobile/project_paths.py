...
DEFAULT_DIM_OKTMO_OUTPUT_PATH = PROJECT_ROOT / "data" / "dim" / "oktmo.parquet"
DEFAULT_DIM_TIME_ZONES_CSV_PATH = _RAW_DATA / "time_zones.csv"
DEFAULT_DIM_TIME_ZONES_OUTPUT_PATH = PROJECT_ROOT / "data" / "dim" / "time_zones.parquet"
DEFAULT_DIM_TAC_CSV_PATH = _RAW_DATA / "tacdb_v001.csv"
DEFAULT_DIM_TAC_OUTPUT_PATH = PROJECT_ROOT / "data" / "dim" / "tac.parquet"
DEFAULT_DIM_OKSM_CSV_PATH = _RAW_DATA / "oksm_v001.csv"
DEFAULT_DIM_OKSM_OUTPUT_PATH = PROJECT_ROOT / "data" / "dim" / "oksm.parquet"
...
DEFAULT_DDS_EVENT_ROOT = PROJECT_ROOT / "data" / "dds" / "event"
DEFAULT_DDS_EVENT_DDS_ROOT = PROJECT_ROOT / "data" / "dds" / "event_dds"
DEFAULT_STG_GEO_ALL_OUTPUT_ROOT = PROJECT_ROOT / "data" / "stg" / "geo_all"
DEFAULT_FCT_GEO_INTERVALS_OUTPUT_ROOT = PROJECT_ROOT / "data" / "fct" / "geo_intervals"
DEFAULT_FCT_PERSON_OUTPUT_ROOT = PROJECT_ROOT / "data" / "fct" / "person"
DEFAULT_FCT_MSISDN_IMSI_SCHEMA_PATH = _SCHEMA_ROOT / "fct" / "msisdn_imsi.json"
DEFAULT_FCT_MSISDN_IMEI_SCHEMA_PATH = _SCHEMA_ROOT / "fct" / "msisdn_imei.json"
DEFAULT_FCT_PERSON_SCHEMA_PATH = _SCHEMA_ROOT / "fct" / "person.json"
DEFAULT_SRC_BS_SCHEMA_PATH = _SCHEMA_ROOT / "src" / "bs.json"
DEFAULT_FCT_BS_SCHEMA_PATH = _SCHEMA_ROOT / "fct" / "bs.json"
DEFAULT_FCT_BS_OUTPUT_PATH = PROJECT_ROOT / "data" / "fct" / "bs.parquet"
DEFAULT_DDS_EVENT_SCHEMA_PATH = _SCHEMA_ROOT / "dds" / "event.json"
