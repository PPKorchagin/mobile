...
from mobile.project_paths import (
    ...
    DEFAULT_NB_FCT_BS_EXECUTED_PATH,
    DEFAULT_NB_FCT_BS_NOTEBOOK_PATH,
    DEFAULT_NB_STG_GEO_ALL_EXECUTED_PATH,
    DEFAULT_NB_STG_GEO_ALL_NOTEBOOK_PATH,
    DEFAULT_NB_FCT_GEO_INTERVALS_EXECUTED_PATH,
    DEFAULT_NB_FCT_GEO_INTERVALS_NOTEBOOK_PATH,
    DEFAULT_NB_FCT_PERSON_EXECUTED_PATH,
    DEFAULT_NB_FCT_PERSON_NOTEBOOK_PATH,
    DEFAULT_NB_FCT_MSISDN_IMEI_EXECUTED_PATH,
    DEFAULT_NB_FCT_MSISDN_IMEI_NOTEBOOK_PATH,
    DEFAULT_NB_FCT_MSISDN_IMSI_OPERATOR_EXECUTED_PATH,
    DEFAULT_NB_FCT_MSISDN_IMSI_OPERATOR_NOTEBOOK_PATH,
    DEFAULT_NB_DDS_EVENT_EXECUTED_PATH,
    DEFAULT_NB_DDS_EVENT_NOTEBOOK_PATH,
...
def run_nb_src_bs() -> None:
    if DEFAULT_NB_SRC_BS_EXECUTED_PATH.exists():
        DEFAULT_NB_SRC_BS_EXECUTED_PATH.unlink()
    run_notebook(
        source_notebook=DEFAULT_NB_SRC_BS_NOTEBOOK_PATH,
        executed_notebook=DEFAULT_NB_SRC_BS_EXECUTED_PATH,
    )


def run_nb_src_person() -> None:
    if DEFAULT_NB_SRC_PERSON_EXECUTED_PATH.exists():
        DEFAULT_NB_SRC_PERSON_EXECUTED_PATH.unlink()
    run_notebook(
        source_notebook=DEFAULT_NB_SRC_PERSON_NOTEBOOK_PATH,
        executed_notebook=DEFAULT_NB_SRC_PERSON_EXECUTED_PATH,
    )


def run_nb_src_excl() -> None:
    if DEFAULT_NB_SRC_EXCL_EXECUTED_PATH.exists():
        DEFAULT_NB_SRC_EXCL_EXECUTED_PATH.unlink()
    run_notebook(
...
def run_nb_dds_event() -> None:
    if DEFAULT_NB_DDS_EVENT_EXECUTED_PATH.exists():
        DEFAULT_NB_DDS_EVENT_EXECUTED_PATH.unlink()
    run_notebook(
        source_notebook=DEFAULT_NB_DDS_EVENT_NOTEBOOK_PATH,
        executed_notebook=DEFAULT_NB_DDS_EVENT_EXECUTED_PATH,
    )


def run_nb_fct_bs() -> None:
    if DEFAULT_NB_FCT_BS_EXECUTED_PATH.exists():
        DEFAULT_NB_FCT_BS_EXECUTED_PATH.unlink()
    run_notebook(
        source_notebook=DEFAULT_NB_FCT_BS_NOTEBOOK_PATH,
        executed_notebook=DEFAULT_NB_FCT_BS_EXECUTED_PATH,
    )
...
def run_nb_fct_msisdn_imei() -> None:
    if DEFAULT_NB_FCT_MSISDN_IMEI_EXECUTED_PATH.exists():
        DEFAULT_NB_FCT_MSISDN_IMEI_EXECUTED_PATH.unlink()
    run_notebook(
        source_notebook=DEFAULT_NB_FCT_MSISDN_IMEI_NOTEBOOK_PATH,
        executed_notebook=DEFAULT_NB_FCT_MSISDN_IMEI_EXECUTED_PATH,
    )


def run_nb_fct_msisdn_imsi_operator() -> None:
    if DEFAULT_NB_FCT_MSISDN_IMSI_OPERATOR_EXECUTED_PATH.exists():
        DEFAULT_NB_FCT_MSISDN_IMSI_OPERATOR_EXECUTED_PATH.unlink()
    run_notebook(
        source_notebook=DEFAULT_NB_FCT_MSISDN_IMSI_OPERATOR_NOTEBOOK_PATH,
        executed_notebook=DEFAULT_NB_FCT_MSISDN_IMSI_OPERATOR_EXECUTED_PATH,
    )


def run_nb_fct_geo_intervals() -> None:
    if DEFAULT_NB_FCT_GEO_INTERVALS_EXECUTED_PATH.exists():
        DEFAULT_NB_FCT_GEO_INTERVALS_EXECUTED_PATH.unlink()
    run_notebook(
        source_notebook=DEFAULT_NB_FCT_GEO_INTERVALS_NOTEBOOK_PATH,
        executed_notebook=DEFAULT_NB_FCT_GEO_INTERVALS_EXECUTED_PATH,
    )


def run_nb_fct_person() -> None:
    if DEFAULT_NB_FCT_PERSON_EXECUTED_PATH.exists():
        DEFAULT_NB_FCT_PERSON_EXECUTED_PATH.unlink()
    run_notebook(
        source_notebook=DEFAULT_NB_FCT_PERSON_NOTEBOOK_PATH,
        executed_notebook=DEFAULT_NB_FCT_PERSON_EXECUTED_PATH,
    )
