...
| Режим | Поведение |
|-------|-----------|
| Без флагов | Один прогон с путями `data/src/bs.parquet`, `data/dim/oktmo.parquet`, `data/dim/time_zones.parquet`, `data/stg/bs.parquet` |
...
| ОКТМО | [`build_dim_oktmo.md`](./build_dim_oktmo.md) |
