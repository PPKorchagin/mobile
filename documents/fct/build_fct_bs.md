...
Референс: [`pipelines/stg/bs.py`](../../src/mobile/pipelines/stg/bs.py). Схема витрины: [`bs.json`](../../src/mobile/schema/fct/bs.json).
...
**Константы ETL в коде** (на вход job **не передаются**): `FCT_BS_FIELDS`, `_OPEN_END_TS`, H3/MAPINFO-параметры — см. [`bs.py`](../../src/mobile/pipelines/stg/bs.py).
